...
public class EmployeeManagementSystem
{
        ...
        while (!exit)
        {
            ...
            try
            {
                switch (choice)
                {
                    ...
                    case "6":
                        exit = true;
                        Console.WriteLine("Exiting Employee Management System. Goodbye!");
                        break;
                    default:
            ...
            catch (FormatException ex)
            {
                ...
                Console.WriteLine("Please ensure you enter numbers where expected (e.g., ID, Salary).");
            }
            catch (OverflowException ex)
            {
                Console.WriteLine($"Error: Input value is too large or too small. {ex.Message}");
            }
            catch (ArgumentNullException ex)
            {
                Console.WriteLine($"Error: Input cannot be null. {ex.Message}");
            }
            catch (Exception ex)
            {
    ...
    private void SearchEmployeeById()
    {
        ...
        {
            throw new FormatException("Employee ID must be a valid number.");
        }
    ...
    private void UpdateEmployeeDetails()
    {
        ...
        if (employeeToUpdate != null)
        {
            ...
            if (!string.IsNullOrWhiteSpace(newSalaryInput))
            {
                ...
                {
                    throw new FormatException("Invalid salary format. Salary must be a valid non-negative number.");
                }
            }
