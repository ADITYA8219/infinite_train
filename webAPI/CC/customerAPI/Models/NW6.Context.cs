...
namespace CustomerAPI.Models
{
    ...
    public partial class Northwind1Entities3 : DbContext
    {
        public Northwind1Entities3()
            : base("name=Northwind1Entities3")
        {
        }
        ...
        public virtual ObjectResult<Invoice> GetCustomersByCountry(string country)
        {
            var countryParameter = country != null ?
                new ObjectParameter("Country", country) :
                new ObjectParameter("Country", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Invoice>("GetCustomersByCountry", countryParameter);
        }
    
        public virtual ObjectResult<Invoice> GetCustomersByCountry(string country, MergeOption mergeOption)
        {
            var countryParameter = country != null ?
                new ObjectParameter("Country", country) :
                new ObjectParameter("Country", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Invoice>("GetCustomersByCountry", mergeOption, countryParameter);
        }
    }
}
